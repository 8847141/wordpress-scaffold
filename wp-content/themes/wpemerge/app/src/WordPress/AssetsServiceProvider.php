...
class AssetsServiceProvider implements ServiceProviderInterface
{
	...
	public function enqueueFrontendAssets() {
		...
		// Enqueue scripts.
		\YunluTheme::core()->assets()->enqueueScript(
			'theme-js-bundle',
			\YunluTheme::core()->assets()->getBundleUrl( 'frontend', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \YunluTheme::core()->assets()->getBundleUrl( 'frontend', '.css' );

		if ( $style ) {
			\YunluTheme::core()->assets()->enqueueStyle(
				'theme-css-bundle',
				$style
			);
		}
		...
		\YunluTheme::core()->assets()->enqueueStyle( 'theme-styles', get_template_directory_uri() . '/style.css' );
	}
	...
	public function enqueueAdminAssets() {
		...
		\YunluTheme::core()->assets()->enqueueScript(
			...
			\YunluTheme::core()->assets()->getBundleUrl( 'admin', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \YunluTheme::core()->assets()->getBundleUrl( 'admin', '.css' );
	...
	public function enqueueLoginAssets() {
		...
		\YunluTheme::core()->assets()->enqueueScript(
			...
			\YunluTheme::core()->assets()->getBundleUrl( 'login', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \YunluTheme::core()->assets()->getBundleUrl( 'login', '.css' );
	...
	public function enqueueEditorAssets() {
		...
		\YunluTheme::core()->assets()->enqueueScript(
			...
			\YunluTheme::core()->assets()->getBundleUrl( 'editor', '.js' ),
			[ 'jquery' ],
			true
		);
	}
	...
	public function addFavicon() {
		\YunluTheme::core()->assets()->addFavicon();
	}
