...
namespace YunluTheme\CarbonFields;
...
class CarbonFieldsServiceProvider implements ServiceProviderInterface {
	...
	protected function registerThemeOptions() {
		Container::make( 'theme_options', __( 'Theme Options', 'yunlu_theme' ) )
			->set_page_file( 'yunlu_theme-theme-options.php' )
			->add_fields( array(
				Field::make( 'text', 'crb_google_maps_api_key', __( 'Google Maps API Key', 'yunlu_theme' ) ),
				Field::make( 'header_scripts', 'crb_header_script', __( 'Header Script', 'yunlu_theme' ) ),
				Field::make( 'footer_scripts', 'crb_footer_script', __( 'Footer Script', 'yunlu_theme' ) ),
			) );
	}
	...
	protected function registerPostMeta() {
		/*
		Container::make( 'post_meta', __( 'Custom Data', 'yunlu_theme' ) )
	...
	protected function registerTermMeta() {
		/*
		Container::make( 'term_meta', __( 'Custom Data', 'yunlu_theme' ) )
	...
	protected function registerUserMeta() {
		/*
		Container::make( 'user_meta', __( 'Custom Data', 'yunlu_theme' ) )
			->add_fields( array(
				Field::make( 'image', 'crb_img' ),
			));
		*/
	...
	public function registerWidgets() {
		register_widget( \YunluTheme\Widgets\Carbon_Rich_Text_Widget::class );
	}
}
